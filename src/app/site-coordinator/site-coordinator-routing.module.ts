...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: "siteParticipants/:siteId",
        component: SiteParticipantsListComponent,
      },
      {
        path: "siteParticipants/:siteId",
        component: SiteParticipantsListComponent,
      ...
      {
        path: "studyParticipants/:studyId",
        component: StudyParticipantsListComponent,
      },
      {
        path: "appParticipants/:appId",
        component: AppParticipantsListComponent,
      },
      {
        path: "participantDetail/:partcipantId",

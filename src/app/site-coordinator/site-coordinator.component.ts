...
export class SiteCoordinatorComponent implements OnInit {
  ...
  onActivate(componentRef) {
    ...
    if (this.componentRef.constructor.name == "DashboardComponent") {
      ...
      this.componentRef.constructor.name == "SiteParticipantsListComponent" ||
      this.componentRef.constructor.name == "AppParticipantsListComponent"
    ) {
      this.searchPlaceholder = "Search by Participant Email";
    } else if (
      this.componentRef.constructor.name == "StudyParticipantsListComponent"
    ) {
